...
function tuesday() {
  // document.getElementById("weekList2").style.background = "green";
  // document.getElementById("weekList2").style.borderRadius = "10px";
  ...
  img.src = "https://github.com/ManmeetMoudgill/GymWebsite/blob/copyOfGymWebsite/imagesWebsite/fit-boxing.svg";
  ...
  img3.src = "https://github.com/ManmeetMoudgill/GymWebsite/blob/copyOfGymWebsite/imagesWebsite/doubmell.svg";
